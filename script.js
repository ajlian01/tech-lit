...
const translations = {
    ...
    es: {
        ...
        typingInstr: "¡Escribe la frase exactamente como se muestra!", textSizeLbl: "Tamaño de Texto:", typingStart: "Empieza a escribir...", skipBtn: "Siguiente Frase ➔",
    ...
    zh: {
        ...
        typingInstr: "请准确输入下方显示的句子！", textSizeLbl: "文字大小:", typingStart: "在上方开始打字...", skipBtn: "下一句 ➔",
    ...
    ja: {
        ...
        typingInstr: "下の文章をそのまま入力してください！", textSizeLbl: "文字サイズ:", typingStart: "ここに入力してね...", skipBtn: "次のフレーズ ➔",
    ...
    ko: {
        ...
        typingInstr: "아래 문장을 똑같이 입력하세요!", textSizeLbl: "글자 크기:", typingStart: "위에 입력하세요...", skipBtn: "다음 문장 ➔",
        greatJob: "참 잘했습니다!", victoryMsg: "연습을 완료했습니다!", backHome: "메인 메뉴로 돌아가기"
    }
};

const phraseBanks = {
    en: ["Hello World", "The quick brown fox", "Learning technology is fun", "Practice makes perfect"],
    es: ["Hola Mundo", "El perro corre rápido", "Aprender es divertido", "La práctica hace al maestro"],
    zh: ["你好世界", "熟能生巧", "学习新技术", "坚持就是胜利"],
    ja: ["こんにちは", "習うより慣れろ", "パソコンの練習", "継続は力なり"],
    ko: ["안녕하세요", "연습하면 잘할 수 있어요", "컴퓨터 배우기", "참 잘했습니다"]
};
...
function startResizeGame() {
    ...
    // Monitor element dimensions for expansion victory
...
function loadNextPhrase() {
    const bank = phraseBanks[currentLang] || phraseBanks['en'];
    const targetPhrase = bank[currentPhraseIndex % bank.length];
